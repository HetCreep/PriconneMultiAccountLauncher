...
def in_py(key):
    for file in glob.glob("**/*.py", root_dir="PriconneMultiAccountLauncher", recursive=True):
        with open(f"PriconneMultiAccountLauncher/{file}", "r", encoding="utf-8") as f:
...
i18n = i18n_flatten(yaml_load["en_US"], "app")
